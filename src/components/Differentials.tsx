import { Plug, Cog, Shield, ArrowRight } from "lucide-react";
          ...
          <div className="space-y-4">
            {differentials.map((item, index) => {
              ...
              return (
                <div 
                  key={index}
                  className="glass rounded-2xl p-6 flex items-start gap-4 hover:border-primary/50 transition-all duration-300 group animate-fade-in-up"
